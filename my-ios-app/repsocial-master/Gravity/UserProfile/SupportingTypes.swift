...
public extension View {
    func maxValues(_ value: Int?) -> some View {
        environment(\.maxValues, value)
    }
}

public extension View {
    func selectionEnabled(_ value: Bool) -> some View {
        environment(\.selectionEnabled, value)
    }
}
...
struct MaxValuesEnvironmentKey: EnvironmentKey {
    static var defaultValue: Int? = nil
}

extension EnvironmentValues {
    var maxValues: Int? {
        get { self[MaxValuesEnvironmentKey.self] }
        set { self[MaxValuesEnvironmentKey.self] = newValue }
    }
}

struct SelectionEnabledEnvironmentKey: EnvironmentKey {
    static var defaultValue: Bool = true
}

extension EnvironmentValues {
    var selectionEnabled: Bool {
        get { self[SelectionEnabledEnvironmentKey.self] }
        set { self[SelectionEnabledEnvironmentKey.self] = newValue }
    }
}
